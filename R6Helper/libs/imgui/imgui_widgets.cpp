...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    // Here we need only to move this button when it's hovered, so we don't need a struct for more animation, 1 float is enough
    static std::map<ImGuiID, float> anim; // #include <map> on top of this file, where is "imgui.h" located.
    ...
    ImVec2 pos = window->DC.CursorPos - ImVec2(0, it_anim->second);
    ...
    it_anim->second = ImLerp(it_anim->second, (hovered || held ? 5.f : 0), g.IO.DeltaTime * 15.f);

    // Render
    const ImU32 inside_col[4] = { ImColor(147, 190, 66, 255)/*topleft*/, ImColor(173, 221, 113, 255)/*topright*/, ImColor(147, 190, 66, 255)/*botright*/, ImColor(147, 190, 66, 255)/*botleft*/ };
